<?php
    ...
    // добавляем показания DHT датчика при наличии
    if (isset($_REQUEST['dht_t']) and $_REQUEST['dht_t'] !== 'nan') {
        IoT::addDHTData($DEVICE['id'], 'dht_t', prepareString($_REQUEST['dht_t']));
        IoT::addDHTData($DEVICE['id'], 'dht_h', prepareString($_REQUEST['dht_h']));
    }
