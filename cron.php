                ...
                <div class="card-block">
                        ...
                        <table class="table table-striped table-borderless table-header-bg">
							...
							<?php foreach(CCron::getTasks($limit, 'ASC') as $task):	?>
								<tr data-name="<?php echo htmlspecialchars($task['name']);?>" data-id="<?php echo $task['id'];?>">
									...
									<td class="mob_hide"><code><?php echo htmlspecialchars(base64_decode($task['command']));?></code></td>
									<td class="text-center">
                                        <div class="btn-group">
	                                        <button onClick="javascript:window.location.href='cron.php?run_task=Y&task_id=<?php echo $task['id'];?>'" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Запустить задание"><i class="fa fa-power-off"></i></button>
                                            <button onClick="javascript:window.location.href='edit_cron.php?id=<?php echo $task['id'];?>'" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Редактировать задание"><i class="ion-edit"></i></button>
                                            <button onClick="javascript:window.location.href='cron.php?remove_task=Y&task_id=<?php echo $task['id'];?>'" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Удалить задание"><i class="ion-close"></i></button>
                                        </div>
                                    </td>
